...
---
background-image: url(figs/me.jpg)
...
<br>
[Twitter: @mmfbee](https://twitter.com/mmfbio)
<br>
[Github: /mmfava](https://github.com/mmfava)
<br>
[Site: mariliamelofavalesso.com](https://www.mariliamelofavalesso.com/)

---
class: clear
background-image: url(figs/Slide1.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide2.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide3.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide4.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide5.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide6.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide7.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide8.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide9.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide10.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide11.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide12.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide13.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide14.JPG)
background-size: 1000px
---
class: clear
background-image: url(figs/Slide15.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide16.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide17.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide18.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide19.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide20.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide21.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide22.JPG)
background-size: 1000px
---
class: clear
background-image: url(figs/Slide23.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide24.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide25.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide26.JPG)
background-size: 1000px

---
class: clear
background-image: url(figs/Slide27.JPG)
background-size: 1000px
...
.center[
<img src="figs/repo_loc.png" style="width:80%;"/>
]
...
<img src="figs/repo_remoto.jpg" style="width:80%;"/>
...
.center[
<img src="figs/pasta_repo.png" style="width:80%;">
]
---
## Criar um repositório local pelo RStudio
...
.center[
<img src="figs/arquivos_repo.png">
]
...
.center[
<img src="figs/repo_remoto.jpg" style="width:100%;"/>
]
...
<img src="figs/Slide23.png" style="width:90%;"/>
...
<img src="figs/modificacoes.png">


---
<div class="background" style="width: 1000px; height: 700px; white-space: nowrap; overflow-x: scroll; border: 0; padding: 10px;">

<img src="figs/modificacoes2.png">

---

<div class="background" style="width: 1000px; height: 700px; white-space: nowrap; overflow-x: scroll; border: 0; padding: 10px;">

<img src="figs/modificacoes3.png">

---
<div class="background" style="width: 1000px; height: 700px; white-space: nowrap; overflow-x: scroll; border: 0; padding: 10px;">

<img src="figs/modificacoes4.png">

---
<div class="background" style="width: 1000px; height: 700px; white-space: nowrap; overflow-x: scroll; border: 0; padding: 10px;">

<img src="figs/modificacoes5.png">

---

<div class="background" style="width: 1000px; height: 700px; white-space: nowrap; overflow-x: scroll; border: 0; padding: 10px;">

<img src="figs/modificacoes6.png">
...
.center[
<img src="figs/vimos.png" style="width:80%;"/>
]

---
## Do GitHub para o Git local
.center[
<img src="figs/veremos.png" style="width:80%;"/>
]
...
### [R-Ladies Fortaleza](https://www.meetup.com/pt-BR/rladies-fortaleza/events/275030815/) 💙
